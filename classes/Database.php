...
class Database {
    ...
    public static function getInstance() { // вызывается конструктор

        if(!isset(self::$instance)) {  // проверка на существование подключения
            self::$instance = new Database;  // создает экземпляр класса
        }
